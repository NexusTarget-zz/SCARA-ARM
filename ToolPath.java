...
public class ToolPath
{
    ...
    public ToolPath()
    {
        ...
        n_steps = 5;   //change for how precise
    ...
    public void convert_drawing_to_angles(Drawing drawing,Arm arm,String fname){
        ...
        for (int i = 1;i < drawing.get_drawing_size(); i++){//-1;i++){ 
            // take two points
            PointXY draw;
            //if(i == drawing.get_drawing_size()){
              //  draw = drawing.get_drawing_point(i);
            //}else {draw = drawing.get_drawing_point(i+1);}
            
            PointXY p0 = drawing.get_drawing_point(i-1);  //i
            PointXY p1 = drawing.get_drawing_point(i);     //i+1
